...
import 'package:clone_ui/multilist/recent_files_json.dart';
...
class FileDetailPage extends StatefulWidget {
  ...
  const FileDetailPage({super.key, required this.title, required this.fileCount});
...
class _FileDetailPageState extends State<FileDetailPage> {
  ...
  Widget getAppBar(){
    return AppBar(
      ...
      }, icon: Icon(Icons.arrow_downward,color: black,)),
  ...
  Widget getDateSection(){
    return Row(
      ...
      children: [
        ...
        }, icon: Icon(Icons.border_all_outlined,color: black.withOpacity(0.5),))
      ],
    );
  }
